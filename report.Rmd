...
Code, report and video presentations are available on Xiang Li's github repository at ?????.
...
$$\small engage\_rate = \frac{1}{2}(\frac{favoriate\_count + retweet\_count}{followers\_count}+\frac{favoriate\_count + retweet\_count}{statuses\_count}) $$
